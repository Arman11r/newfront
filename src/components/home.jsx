                    ...
                    <div className="container-regular-2">
                        <div className="navbar-wrapper-3">
                            <a href="#" className="navbar-brand-2 w-nav-brand">
                                <img
                                    src="https://cdn.prod.website-files.com/67892ad20b79c099e7f3f24f/679538ef650ea7503dd61117_Frame%2017.png"
                                    loading="lazy"
                                    alt=""
                                />
                            </a>
                            <nav role="navigation" className="nav-menu-wrapper-2 w-nav-menu">
                                <ul role="list" className="nav-menu w-list-unstyled">
                                    <li><a href="http://www.google.com" className="nav-link-4">Home</a></li>
                                    <li><a href="#" className="nav-link-4">Note Enhancer</a></li>
                                    <li className="list-item"><a href="#" className="nav-link-4">Quizz</a></li>
                                    <li><a href="#" className="nav-link-4">Task</a></li>
                ...
                <div className="container-5">
                    <div className="hero-wrapper-4">
                        <div className="hero-split-4">
                            <h1 className="heading">Transform<br />Your Learning Experience</h1>
                            <p className="my-p heo-p left-align">Ordinary lessons become extraordinary adventures<br />with our tools tailored for diverse learning styles.</p>
                            <a href="#" className="button-primary-5 w-button">Get Started</a>
                        </div>
                        <div className="hero-split-4">
                            <img
